package com.natco.composeexampleapp.ui.theme
...
object PlantsnPetsTheme {
    val colors: PlantsnPetsColors
        @Composable
...
class PlantsnPetsColors(
    ...
    fun update(other: PlantsnPetsColors) {
    ...
    fun copy(): PlantsnPetsColors = PlantsnPetsColors(
...
@Composable
fun ProvidePlantsnPetsColors(
    colors: PlantsnPetsColors,
    content: @Composable () -> Unit
) {
...
private val LocalJetsnackColors = staticCompositionLocalOf<PlantsnPetsColors> {
